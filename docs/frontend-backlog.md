...
[x] TASK-033: Criar testes unitarios e de componente para login e sessao.
...
[x] TASK-048: Criar testes de componente para home, vitrine e card de produto.
...
[x] TASK-055: Implementar estados de resultado vazio e erro recuperavel.
[x] TASK-056: Criar testes de integracao para busca e filtro por categoria.
...
[x] TASK-063: Criar testes de componente e fluxo para detalhe de produto.
...
[x] TASK-076: Reutilizar dados do carrinho ativo.
...
[x] TASK-093: Criar confirmacao explicita antes de cancelar conta.
[x] TASK-094: Criar testes de componente e integracao da area do cliente.

### 12. Alteracao de senha

[x] TASK-095: Implementar rota `/account/password`.
[x] TASK-096: Criar formulario com senha atual, nova senha e confirmacao.
...
[x] TASK-111: Definir rotas protegidas: `/cart`, checkout, `/account`, `/account/profile`, `/account/password` e `/account/orders`.
...
[x] TASK-122: Revisar consistencia visual com `docs/frontend-specs.md`.
...
[x] TASK-130: Criar e2e para area do cliente e alteracao de senha.
[x] TASK-131: Criar e2e para listagem, detalhe e cancelamento de pedido.
[x] TASK-132: Garantir que `lint`, `test`, `build` e `e2e` passam antes da entrega.
